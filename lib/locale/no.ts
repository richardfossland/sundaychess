...
export const no = {
  ...
  duel: {
    cta: "Duell",
    ctaSub: "Utfordre én – ansikt til ansikt",
    landingTitle: "Duell",
    landingSub:
      "Utfordre én motstander. Lag en duell, vis QR-koden, og spill 1 mot 1 på hver sin skjerm.",
    create: "Lag duell",
    createTitle: "Ny duell",
    yourName: "Hva heter du?",
    namePlaceholder: "Ditt navn",
    bestOf: "Antall partier",
    bestOf1: "1 parti",
    bestOf3: "Best av 3",
    bestOf5: "Best av 5",
    clock: "Betenkningstid",
    clockOff: "Uten klokke",
    variant: "Variant",
    start: "Start duell",
    haveCode: "Har du en kode? Gjenoppta",
    // host waiting room
    waitTitle: "Vis denne til motstanderen",
    waitScan: "Scan QR-koden eller gå til",
    waitPin: "og skriv inn PIN",
    waitFor: "Venter på at motstanderen blir med …",
    shareLink: "Kopier lenke",
    shareCopied: "Lenke kopiert!",
    // join
    joinTitle: "Du er utfordret!",
    joinSub: "Skriv navnet ditt for å starte duellen",
    joinCta: "Ta utfordringen",
    full: "Duellen er allerede i gang eller full.",
    notFound: "Fant ingen duell med den PIN-en.",
    // match / interlude
    matchScore: "Stilling",
    you: "Du",
    opponent: "Motstander",
    ...
    points: "poeng",
    gameNo: "Parti",
    nextGame: "Neste parti starter …",
    youWhiteNext: "Du spiller hvit i neste parti",
    youBlackNext: "Du spiller svart i neste parti",
    waitOpponentNext: "Venter på motstanderen …",
    // result
    youWonMatch: "Du vant duellen! 🏆",
    youLostMatch: "Du tapte duellen",
    tied: "Uavgjort duell",
    finalScore: "Sluttstilling",
    rematch: "Ny duell",
