 ...
 * a shared store all isolates read/write (edge KV or a Durable Object);
 * tracked in docs/ROBUSTNESS-BACKLOG.md ("Rate limiter → shared store"). Returns
 * a 429 Response when over the cap, else null. */
