...
/** One client-telemetry event as the host diagnostics modal sees it (T5).
 * Deliberately carries NO name — the modal joins `playerId` against the board
 * state it already has, so the roster never travels with the log. */
