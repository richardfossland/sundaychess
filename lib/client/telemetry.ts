...
// Client beacon (T5). The ONE place the browser reports "something went wrong"
// so the teacher can read afterwards WHY a student was thrown out or a board
// froze. Everything here is deliberately tiny and deliberately anonymous.
//
...
//   * it must NEVER throw — a broken beacon must not break a chess game.
 ...
 * screen in the app (a crash in /solo, /host, /versus or the root layout goes
 ...
 * stored student session; /solo, /versus and /host have identities of their own
