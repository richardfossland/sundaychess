...
Hver hendelse er én rad i `public.client_events`:
...
anonym: den kan komme fra `/solo`, `/versus`, `/host` eller rot-layoutet, og
...
**14 dager.** En pg_cron-jobb (`cleanup-client-events`, 04:20 UTC) sletter alt
eldre. Sletting av en turnering fjerner ikke radene automatisk — de dør på
klokka, uansett.
